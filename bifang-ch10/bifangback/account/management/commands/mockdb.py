...
class Command(BaseCommand):
    ...
    def add_release_status(self):
        ...
        create_user = User.objects.get(username=username)
        status_list = ['Create', 'Building', 'BuildFailed',
                       'Build', 'Ready', 'Ongoing', 'Success', 'Failed']
        status_value_list = ['创建', '编译中', '编译失败',
    ...
    def add_release(self):
        ...
        for number in range(100):
            ...
            Release.objects.create(name=name,
                                   ...
                                   deploy_script_url='http://1.2.3.4/a/b/bifang.sh',
                                   zip_package_url='http://1.2.3.4/a/b/go-demo.zip',
