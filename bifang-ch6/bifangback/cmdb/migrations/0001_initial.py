# Generated by Django 3.1.4 on 2021-04-03 00:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
                ('env', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ra_release', to='cmdb.env', verbose_name='环境')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
                ('env', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ra_server', to='cmdb.env', verbose_name='环境')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('base_status', models.BooleanField(default=True)),
                ('status_value', models.CharField(blank=True, default='Ready', max_length=1024, verbose_name='状态值')),
                ('create_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_no', models.IntegerField(blank=True, default=0, null=True, verbose_name='部署启停批次')),
        ...
        migrations.AddField(
            model_name='server',
            name='server_status',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ra_server', to='cmdb.serverstatus', verbose_name='服务器状态'),
        ),
        migrations.CreateModel(
            name='SaltTb',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_no', models.IntegerField(blank=True, default=0, null=True, verbose_name='部署批次')),
                ('log', models.TextField(verbose_name='日志内容')),
                ('create_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
                ...
                ('release_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ra_release_history', to='cmdb.releasestatus', verbose_name='发布单状态')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical ServerStatus服务器状态',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_status', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='cmdb.serverstatus', verbose_name='服务器状态')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('release', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='cmdb.release', verbose_name='发布单')),
                ('release_status', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='cmdb.releasestatus', verbose_name='发布单状态')),
            ],
            options={
